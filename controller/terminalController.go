...
func TerminalController(terminalService service.TerminalServiceInterface) *terminalController {
...
func (controller *terminalController) GetTerminal(context *gin.Context) {
	...
	if error != nil {
		...
		list_ticket, error := controller.terminalController.GetTerminal(request)
