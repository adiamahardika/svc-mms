...
func (controller *hwReplacementStatusController) DeleteHwReplacementStatus(context *gin.Context) {
	...
	error = controller.hwReplacementStatusService.DeleteHwReplacementStatus(&id)
